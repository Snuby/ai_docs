!function() {
            ...
            e.prototype.onchange = function(i) {
                ...
                void 0 === i && (i = d),
                    p("click", function(e) {
                        ...
                        n && "A" === n.tagName && !/_blank/.test(n.target) && (e.preventDefault(),
                            n = n.href,
                            -1 !== o.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({
                                key: n
                            }, "", n),
                            i({
                                event: e,
    ...
    function Cn(e) {
        if ("string" != typeof e)
            return "";
        var n = e.trim().replace(/[A-Z]+/g, Tn).replace(/<[^>]+>/g, "").replace(En, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1")
            , e = Fn[n]
            , e = u.call(Fn, n) ? e + 1 : 0;
        ...
        return e.replace(/<(code|pre|script|template)[^>]*?>[\s\S]+?<\/(code|pre|script|template)>/g, function(e) {
            ...
            return i = e,
                ...
                i = n ? e && /unicode/.test(n) ? '<span class="emoji">' + n.replace("unicode/", "").replace(/\.png.*/, "").split("-").map(function(e) {
                    return "&#x" + e + ";"
                }).join("&zwj;").concat("&#xFE0E;") + "</span>" : '<img src="' + Rn.baseURL + n + '.png" alt="' + o + '" class="emoji" loading="lazy">' : i;
            var i, o
        }).replace(/__colon__/g, ":")
    }
    function On(e) {
    ...
    var qn, Pn = be(function(e) {
        var u, f, p, d, n, g = function(u) {
            var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i
                ...
                util: {
                    encode: function e(n) {
                        return n instanceof C ? new C(n.type,e(n.content),n.alias) : Array.isArray(n) ? n.map(e) : n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                    },
                    type: function(e) {
                ...
                languages: {
                    ...
                    txt: e,
                    extend: function(e, n) {
                        var i, o = T.util.clone(T.languages[e]);
                        for (i in n)
                            o[i] = n[i];
                        return o
                    },
                    insertBefore: function(i, e, n, o) {
                        var t, a = (o = o || T.languages)[i], r = {};
                        for (t in a)
                    ...
                    DFS: function e(n, i, o, t) {
                        t = t || {};
                        var a, r, c, u = T.util.objId;
                        for (a in n)
                            n.hasOwnProperty(a) && (i.call(n, a, n[a], o || a),
                                r = n[a],
                                "Object" !== (c = T.util.type(r)) || t[u(r)] ? "Array" !== c || t[u(r)] || (t[u(r)] = !0,
                                    e(r, i, a, t)) : (t[u(r)] = !0,
                                    e(r, i, null, t)))
                    }
                },
                    ...
                    T.hooks.run("before-highlight", r),
                        r.grammar ? n && u.Worker ? ((n = new Worker(T.filename)).onmessage = function(e) {
                            ...
                            n.postMessage(JSON.stringify({
                                ...
                                code: r.code,
                                immediateClose: !0
                            }))) : c(T.highlight(r.code, r.grammar, r.language)) : c(T.util.encode(r.code))
                },
                highlight: function(e, n, i) {
                    ...
                    if (T.hooks.run("before-tokenize", i),
                        !i.grammar)
                        throw new Error('The language "' + i.language + '" has no grammar.');
                    return i.tokens = T.tokenize(i.code, i.grammar),
            ...
            if (u.Prism = T,
                ...
                ,
                !u.document)
                return u.addEventListener && (T.disableWorkerMessageHandler || u.addEventListener("message", function(e) {
            ...
            return o && (T.filename = o.src,
            o.hasAttribute("data-manual") && (T.manual = !0)),
            T.manual || ("loading" === (e = document.readyState) || "interactive" === e && o && o.defer ? document.addEventListener("DOMContentLoaded", t) : window.requestAnimationFrame ? window.requestAnimationFrame(t) : window.setTimeout(t, 16)),
                T
    ...
    In.prototype.compileEmbed = function(e, n) {
        var i, o, t = On(n), a = t.str, t = t.config;
        if (n = a,
            t.include)
            return T(e) || (e = q(this.contentBase, R(this.router.getCurrentPath()), e)),
                ...
                t.link = (i = (n = {
                        ...
                        i.link = function(e, n, i) {
                            ...
                            return u = t.target || u,
                                ...
                                n = a,
                                T(e) || f._matchNotCompileLink(e) || t.ignore ? (T(e) || "./" !== e.slice(0, 2) || (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e),
    ...
    function Wn(n, i, o, t, a, e) {
        n = e ? n : n.replace(/\/$/, ""),
        (n = R(n)) && X(a.router.getFile(n + o) + i, !1, a.config.requestHeaders).then(t, function(e) {
            return Wn(n, i, o, t, a)
        })
    }
    function Xn() {
